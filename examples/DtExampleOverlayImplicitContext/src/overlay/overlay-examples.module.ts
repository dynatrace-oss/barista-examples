...
@NgModule({
    ...
    declarations: [DtExampleOverlayImplicitContext, DtExampleOverlayProgrammaticDummy],
    exports: [DtExampleOverlayImplicitContext, DtExampleOverlayProgrammaticDummy],
})
